...
class ParseTreeVisitor:
    ...
    def visitErrorNode(self, node: ErrorNode) -> Any: ...
    def defaultResult(self) -> Any: ...
    def aggregateResult(
        self, aggregate: Any, nextResult: _GenericType
    ) -> _GenericType: ...
    def shouldVisitNextChild(self, node: Any, currentResult: Any) -> Literal[True]: ...
...
class TerminalNodeImpl(TerminalNode):
    ...
    def getSourceInterval(
        self,
    ) -> tuple[Literal[-1], Literal[-2]] | tuple[int | None, int | None]: ...
